...
func (t *TextInputMapper) toDto(questionEntity *question2.Question) (*get.TextInputDto, error) {
...
func (t *TextInputMapper) AnswersToDto(textInputAnswers []question2.TextInputAnswer) []string {
